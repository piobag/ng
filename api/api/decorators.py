...
def paginated(f):
    ...
    def wrapped(*args, **kwargs):
        pagination = {}
        pagination['after'] = request.args.get('after', -999999999999)
        pagination['limit'] = request.args.get('limit', 5, type=int)
        pagination['offset'] = request.args.get('offset', 0, type=int)

        return f(pagination, *args, **kwargs)
    return wrapped
